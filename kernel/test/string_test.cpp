...
void memcmp_returns_zero_when_memory_equal()
{
    ...
    if (result == 0)
    {
        debug_log::log_to_display(debug_log::Options{debug_log::Severity::Info}, "memcmp_returns_zero_when_memory_equal passed\n");
    }
    else
    {
...
void memcmp_returns_negative_1_when_first_argument_sorts_before_second()
{
    ...
    if (result == -1)
    {
        debug_log::log_to_display(debug_log::Options{debug_log::Severity::Info}, "memcmp_returns_negative_1_when_first_argument_sorts_before_second passed\n");
    }
    else
    {
...
void memcmp_returns_postive_1_when_first_argument_sorts_after_second()
{
    ...
    if (result == 1)
    {
        debug_log::log_to_display(debug_log::Options{debug_log::Severity::Info}, "memcmp_returns_postive_1_when_first_argument_sorts_after_second passed\n");
    }
    else
    {
...
void strlen_returns_zero_on_empty_string()
{
    ...
    if (length == 0)
    {
        debug_log::log_to_display(debug_log::Options{debug_log::Severity::Info}, "strlen_returns_zero_on_empty_string passed\n");
    }
    else
    {
...
void strlen_returns_4_for_test_string()
{
    ...
    if (length == 4)
    {
        debug_log::log_to_display(debug_log::Options{debug_log::Severity::Info}, "strlen_returns_4_for_test_string passed\n");
    }
    else
    {
